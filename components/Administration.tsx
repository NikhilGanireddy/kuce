...
const Administration = () => {
    ...
    return <main className={`container w-full py-12 flex flex-col justify-center items-center gap-12`}>
        <h1 className={`text-3xl font-medium text-red-600`}>Administration</h1>
        <div className={`grid grid-cols-1 lg:grid-cols-3 gap-12 w-full`}>
            <div className={`  lg:  gap-6 flex justify-center items-center flex-col`}>
                <Image className={`object-center object-cover w-48 h-48 rounded-2xl`}
